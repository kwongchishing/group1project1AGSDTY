using UnityEngine;public class killtowerattacker:MonoBehaviour{
    ...
    public GameObject defenseminimapicon,missionsuccesscanvas, TowerhealthCanvas,missionfailcanvas,bgm1,defensebgm,defenseTowerFX,defendtowermonster,All_colliWall;
    public save2 save2;
    void Update(){
        if(killcount>=19){            
